...
>  - 这里的 task list 是本人测评在Obsidian支持的 Mermaid 格式，check 的是不支持的，或者本人还需要核对是啥问题导致不能显示的 ，详细资料在上方 `resource` 下，请自行查看，另外本人测评的文件由于还没有把知识库发布为网站，在这里无法显示跳转
> - 如要使用Mermaid ，建议在在线编辑网站（resource中的：[Editor | Mermaid Chart]）做好后，复制粘贴到 MD文档进行显示，也可以在网站将图表导出为.svg .png格式
