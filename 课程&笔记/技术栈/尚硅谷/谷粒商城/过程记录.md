...
1.  环境搭建
	...
	4. 安装docker，配置阿里云镜像下载dockerhub中的镜像去docker hub安装镜像，"[Install Docker Engine on CentOS | Docker Documentation](https://docs.docker.com/engine/install/centos/)",本人用了魔法，but 这里还是配个阿里云镜像加速
          1. 卸载旧版本docker：
                ```    r
